...
namespace resetacl
{
    class Program
    {
        ...
        private static void LoadInputParameters()
        {
            ...
            if (Enum.TryParse<LogLevels>(ConfigurationManager.AppSettings.Get("LoggingLevel"), out ll)) LogLevel = ll;
        }
        ...
        public static void th_execQueue(object p_queue_obj)
        {
            ...
            try
            {
                print.debug(threadInfo + " is working on CPU " + GetCurrentProcessorNumber());
